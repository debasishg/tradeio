...
object Algebras {
  def make[F[_]: Sync](
    ...
    for {
      accountRepositoryInterpreter <- AccountRepositoryInterpreter.make[F](sessionPool)
      executionRepositoryInterpreter <- ExecutionRepositoryInterpreter.make[F](sessionPool)
      instrumentRepositoryInterpreter <- InstrumentRepositoryInterpreter.make[F](sessionPool)
      orderRepositoryInterpreter <- OrderRepositoryInterpreter.make[F](sessionPool)
      tradeRepositoryInterpreter <- TradeRepositoryInterpreter.make[F](sessionPool)
